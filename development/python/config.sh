...
conda install autopep8 conda=22.9.0 cppcheck cpplint isort jupyter libjpeg-turbo=2.1.4 libpng matplotlib numpy onnx opencv pillow pycodestyle pylint pytest pytest-cov pytorch shellcheck torchvision tox visdom
